...
class NotificationPolicyComprehensiveTest extends TestCase
{
    ...
    public function test_user_cannot_restore_notification()
    {
        $user = new User();
        $notification = new Notification();
        $policy = new NotificationPolicy();

        $this->assertFalse($policy->restore($user, $notification));
    }

    public function test_user_cannot_force_delete_notification()
    {
        $user = new User();
        $notification = new Notification();
        $policy = new NotificationPolicy();

        $this->assertFalse($policy->forceDelete($user, $notification));
    }
}